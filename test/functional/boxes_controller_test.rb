...
class BoxesControllerTest < ActionController::TestCase
  ...
  test "should create box" do
    assert_difference('Box.count') do
      post :create, box: { background: @box.background, bigad: @box.bigad, description: @box.description, query: @box.query, smallad: @box.smallad, title: @box.title }
    end
  ...
  test "should update box" do
    put :update, id: @box, box: { background: @box.background, bigad: @box.bigad, description: @box.description, query: @box.query, smallad: @box.smallad, title: @box.title }
    assert_redirected_to box_path(assigns(:box))
  end
